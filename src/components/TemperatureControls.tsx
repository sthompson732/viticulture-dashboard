...
import { TemperatureLayerStyle } from '../types';
import DatePicker from 'react-datepicker';
import "react-datepicker/dist/react-datepicker.css";
import './TemperatureControls.css';

interface TemperatureControlsProps {
  layerStyles: TemperatureLayerStyle;
  setLayerStyles: (styles: TemperatureLayerStyle) => void;
}

const TemperatureControls: React.FC<TemperatureControlsProps> = ({ layerStyles, setLayerStyles }) => {
  ...
  return (
    <Box className="temperature-controls">
