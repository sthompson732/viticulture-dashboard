...
import { Slider, Typography, Box, TextField, Select, MenuItem, InputLabel, FormControl, SelectChangeEvent } from '@mui/material';
import { SketchPicker } from 'react-color';
import { SoilLayerStyle } from '../types';
import DatePicker from 'react-datepicker';
import "react-datepicker/dist/react-datepicker.css";
import './SoilControls.css';

interface SoilControlsProps {
  layerStyles: SoilLayerStyle;
  setLayerStyles: (styles: SoilLayerStyle) => void;
}

const SoilControls: React.FC<SoilControlsProps> = ({ layerStyles, setLayerStyles }) => {
